...
describe "AtomProcessing", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('atom-processing')
  ...
  describe "when the atom-processing:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-processing:toggle'
        expect(atomProcessingPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-processing:toggle'
        expect(atomProcessingElement).not.toBeVisible()
